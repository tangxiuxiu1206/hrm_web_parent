<template>
    ...
    private Long pid;
		...
		<el-table :data="courseTypes" v-loading="listLoading" highlight-current-row  style="width: 100%;">
			...
			<el-table-column prop="pid" label="父类型">
			</el-table-column>
		...
		<el-dialog title="添加或修改" :visible.sync="formVisible" :close-on-click-modal="false">
			<el-form :model="courseType" label-width="80px" :rules="formRules" ref="courseType">
				...
				<!--<el-form-item label="父类型" prop="parent.name">-->
					<!--<el-input v-model="courseType.parent.name" auto-complete="off"></el-input>-->
				<!--</el-form-item>-->

				<el-form-item label="父类型" prop="parent.name">
				<el-select v-model="courseType.parent" placeholder="请选择">
				<el-option
